...
public class NightCommand extends Command {
    ...
    public NightCommand(VaroDE plugin) {
    ...
    public boolean execute(CommandSender sender, String s, String[] strings) {
        if (sender instanceof Player) {
            ...
            if (player.hasPermission("mario.night") || player.hasPermission("mario.*") || player.hasPermission("*") || sender.isOp()) {
                sender.sendMessage(VaroDE.getPrefix() + "Die Zeit wurde auf Nacht gestellt.");
